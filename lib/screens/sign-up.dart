...
import 'package:remember_me/components/FacePainter.dart';
import 'package:remember_me/components/auth-action-button.dart';
import 'package:remember_me/components/camera_header.dart';
import 'package:remember_me/services/camera.service.dart';
            ...
            children: [
              ...
              CameraHeader(
                ...
                onBackPressed: () async => {
                  ...
                  await deleteFile(File(imagePath)),
                },
              )
            ],
          ),
